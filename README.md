...
For demonstration of the login and account management features this API serves a demo [Vue.js](https://vuejs.org) PWA. The client's source code can be found [here](https://github.com/Dwata-Tech/go-base-vue). Build and put it into the api's _./public_ folder, or use the live development server (requires CORS enabled).
...
[godoc]: https://godoc.org/github.com/Dwata-Tech/go-base
[godoc badge]: https://godoc.org/github.com/Dwata-Tech/go-base?status.svg
[goreportcard]: https://goreportcard.com/report/github.com/Dwata-Tech/go-base
[goreportcard badge]: https://goreportcard.com/badge/github.com/Dwata-Tech/go-base
